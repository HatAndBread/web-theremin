...
export const ThereminOptions = (props) => {
  ...
  const [sineVolume, setSineVolume] = useState(0);
  const [squareVolume, setSquareVolume] = useState(0);
  const [sawtoothVolume, setSawtoothVolume] = useState(0);
  const [triangleVolume, setTriangleVolume] = useState(0);
